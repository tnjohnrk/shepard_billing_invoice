...
export function Modal({ isOpen, onClose, title, children, maxWidth = 'max-w-2xl' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 select-none animate-fade-in">
      <div className={`w-full ${maxWidth} bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-300 dark:border-slate-700 shadow-none flex flex-col max-h-[90vh] overflow-hidden`}>
